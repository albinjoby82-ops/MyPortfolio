export default {
  ...
  tools: {
    ...
    "peptide-calculator": {
      ...
      step_1_title: "Which syringe do you have?",
      step_1_hint: "check the scale printed on it",
      step_2_title: "How much peptide is in your vial?",
      step_2_hint: "the amount of powder written on the label",
      step_3_title: "How much bac water did you put in the vial?",
      step_3_hint: "bacteriostatic water — the sterile water that dissolves the powder",
      step_4_title: "What dose do you want to inject?",
      step_4_hint: "per injection",
      step_4_reverse_title: "How many units do you want to draw?",
      step_4_reverse_hint: "the graduation you read on your syringe",
      other: "Other…",
      units: "units",
      dose_unit: "Dose unit",
      ...
      overflow: "{units} units exceed the {syringe} syringe ({capacity} u). Use a bigger syringe, or dilute with more water.",
      disclaimer_summary: "Conversion tool only — read the disclaimer",
      vial_summary: "{conc} mg/mL · {doses} doses",
      recap: {
        mix: "{mg} mg + {ml} mL",
        concentration: "Concentration {value} mg/mL",
        doses: "{count} doses per vial",
        syringe: "{value} syringe",
        sentence:
          "{mg} mg + {ml} mL → concentration {conc} mg/mL. After {doses} injections of {dose}, the vial is empty.",
      },
      result: {
        eyebrow_forward: "Draw",
        eyebrow_reverse: "That dose is",
        concentration: "Concentration",
        volume_per_dose: "Volume / dose",
        doses_per_vial: "Doses / vial",
        invalid: "Enter a vial amount, a water volume and a dose to see your result.",
        vial_caption: "Your vial",
        toggle: "Show the result details",
        sticky_hint: "the result stays visible while you adjust",
      },
      warnings: {
