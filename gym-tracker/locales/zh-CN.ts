export default {
  ...
  tools: {
    ...
    "peptide-calculator": {
      ...
      how_it_works: "怎么用？",
      settings: "你的设置",
      step_1_title: "你用的是哪种注射器？",
      step_1_hint: "看注射器上印的刻度",
      step_2_title: "你的西林瓶里有多少多肽？",
      step_2_hint: "标签上标注的粉末量",
      step_3_title: "你往瓶里加了多少抑菌水？",
      step_3_hint: "抑菌水 — 溶解粉末的无菌水",
      step_4_title: "你想注射多少剂量？",
      step_4_hint: "每次注射",
      step_4_reverse_title: "你想抽取多少单位？",
      step_4_reverse_hint: "注射器上读到的刻度",
      other: "其他…",
      units: "单位",
      dose_unit: "剂量单位",
      mode_legend: "计算方向",
      mode_forward: "剂量 → 单位",
      mode_reverse: "单位 → 剂量",
      overflow: "{units} 单位超过了 {syringe} 注射器（{capacity} 单位）。请换更大的注射器，或多加一些水稀释。",
      disclaimer_summary: "仅为换算工具 — 请阅读免责声明",
      vial_summary: "{conc} mg/mL · {doses} 次剂量",
      recap: {
        mix: "{mg} mg + {ml} mL",
        concentration: "浓度 {value} mg/mL",
        doses: "每瓶 {count} 次剂量",
        syringe: "{value} 注射器",
        sentence: "{mg} mg + {ml} mL → 浓度 {conc} mg/mL。注射 {doses} 次 {dose} 后，这瓶就用完了。",
      },
      result: {
        eyebrow_forward: "抽取",
        eyebrow_reverse: "该剂量相当于",
        concentration: "浓度",
        volume_per_dose: "每次体积",
        doses_per_vial: "每瓶次数",
        invalid: "请输入西林瓶用量、加水量和剂量以查看结果。",
        vial_caption: "你的西林瓶",
        toggle: "显示结果详情",
        sticky_hint: "调整时结果保持可见",
      },
      warnings: {
        exceeds_syringe: "该剂量超出所选注射器。请更换更大规格的注射器或减少加水量。",
        too_small: "低于2格刻度难以准确测量，请减少加水量以提高体积。",
