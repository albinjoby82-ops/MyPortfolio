export default {
  ...
  tools: {
    ...
    "peptide-calculator": {
      ...
      step_1_title: "¿Qué jeringa tienes?",
      step_1_hint: "mira la escala impresa en ella",
      step_2_title: "¿Cuánto péptido hay en tu vial?",
      step_2_hint: "la cantidad de polvo indicada en la etiqueta",
      step_3_title: "¿Cuánta agua bacteriostática pusiste en el vial?",
      step_3_hint: "el agua bacteriostática — el agua estéril que disuelve el polvo",
      step_4_title: "¿Qué dosis quieres inyectarte?",
      step_4_hint: "por inyección",
      step_4_reverse_title: "¿Cuántas unidades quieres cargar?",
      step_4_reverse_hint: "la graduación que lees en tu jeringa",
      other: "Otro…",
      units: "unidades",
      dose_unit: "Unidad de la dosis",
      mode_legend: "Dirección del cálculo",
      mode_forward: "Dosis → unidades",
      mode_reverse: "Unidades → dosis",
      overflow:
        "{units} unidades superan la jeringa de {syringe} ({capacity} u). Usa una jeringa más grande o diluye con más agua.",
      disclaimer_summary: "Solo herramienta de conversión — lee el aviso",
      vial_summary: "{conc} mg/mL · {doses} dosis",
      recap: {
        mix: "{mg} mg + {ml} mL",
        concentration: "Concentración {value} mg/mL",
        doses: "{count} dosis por vial",
        syringe: "Jeringa de {value}",
        sentence:
          "{mg} mg + {ml} mL → concentración {conc} mg/mL. Tras {doses} inyecciones de {dose}, el vial se acaba.",
      },
      result: {
        eyebrow_forward: "Carga",
        eyebrow_reverse: "Esa dosis equivale a",
        concentration: "Concentración",
        volume_per_dose: "Volumen / dosis",
        doses_per_vial: "Dosis / vial",
        invalid: "Introduce una cantidad de vial, un volumen de agua y una dosis para ver tu resultado.",
        vial_caption: "Tu vial",
        toggle: "Mostrar el detalle del resultado",
        sticky_hint: "el resultado sigue visible mientras ajustas",
      },
      warnings: {
        exceeds_syringe: "Esta dosis es mayor que la jeringa seleccionada. Elige una jeringa más grande o añade menos agua.",
        too_small: "Por debajo de 2 graduaciones, la carga es difícil de medir con precisión. Añade menos agua para aumentar el volumen.",
