...
export default {
  ...
  tools: {
    ...
    "peptide-calculator": {
      title: "Calculadora de Peptídeos",
      description: "Converta uma dose de peptídeo em mililitros e unidades de seringa de insulina U-100",
      how_it_works: "Como funciona?",
      settings: "Suas configurações",
      step_1_title: "Qual seringa você tem?",
      step_1_hint: "veja a escala impressa nela",
      step_2_title: "Quanto peptídeo tem no seu frasco?",
      step_2_hint: "a quantidade de pó indicada no rótulo",
      step_3_title: "Quanta água bacteriostática você colocou no frasco?",
      step_3_hint: "a água bacteriostática — a água estéril que dissolve o pó",
      step_4_title: "Qual dose você quer injetar?",
      step_4_hint: "por injeção",
      step_4_reverse_title: "Quantas unidades você quer puxar?",
      step_4_reverse_hint: "a graduação que você lê na seringa",
      other: "Outro…",
      units: "unidades",
      dose_unit: "Unidade da dose",
      mode_legend: "Direção do cálculo",
      mode_forward: "Dose → unidades",
      mode_reverse: "Unidades → dose",
      overflow:
        "{units} unidades ultrapassam a seringa de {syringe} ({capacity} u). Use uma seringa maior ou dilua com mais água.",
      disclaimer_summary: "Apenas ferramenta de conversão — leia o aviso",
      vial_summary: "{conc} mg/mL · {doses} doses",
      recap: {
        mix: "{mg} mg + {ml} mL",
        concentration: "Concentração {value} mg/mL",
        doses: "{count} doses por frasco",
        syringe: "Seringa de {value}",
        sentence:
          "{mg} mg + {ml} mL → concentração {conc} mg/mL. Depois de {doses} injeções de {dose}, o frasco acaba.",
      },
      result: {
        eyebrow_forward: "Puxe",
        eyebrow_reverse: "Essa dose equivale a",
        concentration: "Concentração",
        volume_per_dose: "Volume / dose",
        doses_per_vial: "Doses / frasco",
        invalid: "Insira a quantidade no frasco, o volume de água e a dose para ver seu resultado.",
        vial_caption: "Seu frasco",
        toggle: "Mostrar os detalhes do resultado",
        sticky_hint: "o resultado continua visível enquanto você ajusta",
      },
      warnings: {
        exceeds_syringe: "Essa dose é maior que a seringa selecionada. Escolha uma seringa maior ou adicione menos água.",
        too_small: "Abaixo de 2 graduações, fica difícil medir com precisão. Adicione menos água para aumentar o volume.",
