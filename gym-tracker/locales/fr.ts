export default {
  ...
  tools: {
    ...
    "peptide-calculator": {
      ...
      step_1_title: "Quelle seringue as-tu ?",
      step_1_hint: "regarde la graduation imprimée dessus",
      step_2_title: "Combien de peptide dans ton flacon ?",
      step_2_hint: "la quantité de poudre inscrite sur l'étiquette",
      step_3_title: "Combien d'eau bac as-tu mise dans le flacon ?",
      step_3_hint: "l'eau bactériostatique — l'eau stérile qui dissout la poudre",
      step_4_title: "Quelle dose veux-tu t'injecter ?",
      step_4_hint: "par injection",
      step_4_reverse_title: "Combien d'unités veux-tu prélever ?",
      step_4_reverse_hint: "la graduation lue sur ta seringue",
      other: "Autre…",
      units: "unités",
      dose_unit: "Unité de la dose",
      mode_legend: "Sens du calcul",
      mode_forward: "Dose → unités",
      mode_reverse: "Unités → dose",
      overflow:
        "{units} unités dépassent la seringue {syringe} ({capacity} u). Prenez une seringue plus grande, ou diluez avec plus d'eau.",
      disclaimer_summary: "Outil de conversion uniquement — lire l'avertissement",
      vial_summary: "{conc} mg/mL · {doses} doses",
      recap: {
        mix: "{mg} mg + {ml} mL",
        concentration: "Concentration {value} mg/mL",
        doses: "{count} doses par flacon",
        syringe: "Seringue {value}",
        sentence:
          "{mg} mg + {ml} mL → concentration {conc} mg/mL. Après {doses} injections de {dose}, le flacon est vide.",
      },
      result: {
        eyebrow_forward: "Prélevez",
        eyebrow_reverse: "Cette dose vaut",
        concentration: "Concentration",
        volume_per_dose: "Volume / dose",
        doses_per_vial: "Doses / flacon",
        invalid: "Entrez une quantité de flacon, un volume d'eau et une dose pour voir votre résultat.",
        vial_caption: "Votre flacon",
        toggle: "Afficher le détail du résultat",
        sticky_hint: "le résultat reste visible tant que vous ajustez",
      },
      warnings: {
        exceeds_syringe: "Cette dose dépasse la seringue sélectionnée. Choisissez une seringue plus grande ou ajoutez moins d'eau.",
        too_small: "En dessous de 2 graduations, le prélèvement est difficile à mesurer précisément. Ajoutez moins d'eau pour augmenter le volume.",
