export default {
  ...
  tools: {
    ...
    "peptide-calculator": {
      title: "Калькулятор пептидов",
      description:
        "Переведите дозу пептида в миллилитры и единицы инсулинового шприца U-100",
      how_it_works: "Как это работает?",
      settings: "Ваши настройки",
      step_1_title: "Какой у вас шприц?",
      step_1_hint: "посмотрите на шкалу, напечатанную на нём",
      step_2_title: "Сколько пептида во флаконе?",
      step_2_hint: "количество порошка, указанное на этикетке",
      step_3_title:
        "Сколько бактериостатической воды вы добавили во флакон?",
      step_3_hint:
        "бактериостатическая вода — стерильная вода, которая растворяет порошок",
      step_4_title: "Какую дозу вы хотите ввести?",
      step_4_hint: "за одну инъекцию",
      step_4_reverse_title: "Сколько единиц вы хотите набрать?",
      step_4_reverse_hint: "деление, которое вы видите на шприце",
      other: "Другое…",
      units: "единиц",
      dose_unit: "Единица дозы",
      mode_legend: "Направление расчёта",
      mode_forward: "Доза → единицы",
      mode_reverse: "Единицы → доза",
      overflow:
        "{units} единиц не помещаются в шприц {syringe} ({capacity} ед.). Возьмите шприц побольше или добавьте больше воды.",
      disclaimer_summary:
        "Только инструмент пересчёта — прочитайте предупреждение",
      vial_summary: "{conc} mg/mL · {doses} доз",
      recap: {
        mix: "{mg} mg + {ml} mL",
        concentration: "Концентрация {value} mg/mL",
        doses: "{count} доз на флакон",
        syringe: "Шприц {value}",
        sentence:
          "{mg} mg + {ml} mL → концентрация {conc} mg/mL. После {doses} инъекций по {dose} флакон закончится.",
      },
      result: {
        eyebrow_forward: "Наберите",
        eyebrow_reverse: "Эта доза равна",
        concentration: "Концентрация",
        volume_per_dose: "Объём / доза",
        doses_per_vial: "Доз / флакон",
        invalid:
          "Введите количество во флаконе, объём воды и дозу, чтобы увидеть результат.",
        vial_caption: "Ваш флакон",
        toggle: "Показать детали результата",
        sticky_hint:
          "результат остаётся на виду, пока вы настраиваете",
      },
      warnings: {
        exceeds_syringe:
          "Эта доза больше выбранного шприца. Выберите шприц большего объёма или добавьте меньше воды.",
        too_small:
          "Меньше 2 делений сложно точно измерить. Добавьте меньше воды, чтобы увеличить объём.",
        water_excess:
          "Это необычно большое количество воды для одного флакона. Перепроверьте значение.",
        not_whole_graduation:
          "Значение попадает между делениями. Ориентируйтесь на ближайшую отметку на шприце.",
      },
    },
    related_title: "Другие бесплатные калькуляторы",
    "one-rep-max": {
